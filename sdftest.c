...
static int test_5(const char* name, float in[5], float expected[5], bool expect_match) {
    ...
    dist_transform_1d((struct view_f){out, out + 5}, (struct view_st){v, v + 5}, (struct view_f){z, z + 4}, &results);
    ...
    printf("Test: %s\n"
           ...
           (double)z[1], (double)z[2], (double)z[3], results.k, results.j, pass ? "pass" : "FAILURE");
...
int main() {
    ...
    if (
        ...
        test_5("increasing", (float[5]){0.f, 1.f, 2.f, 3.f, 4.f}, (float[5]){0.f, 1.f, 2.f, 3.f, 4.f}, true) +
            ...
            // dominated #2
            test_5("dominated 2", (float[5]){0.f, 100.f, 100.f, 100.f, 100.f}, (float[5]){0.f, 1.f, 4.f, 9.f, 16.f},
                   true) +
            // all infinite
